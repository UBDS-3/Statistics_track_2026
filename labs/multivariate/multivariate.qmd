...
1. What does each of the 16 subpanels show?
2. Can you repeat this plot for the `athletes` data?
3. In the lecture, we have seen another way to investigate correlations in the data. Use the `pheatmap` function in the package with the same name, to visualise all pairwise correlations of the results from the ten disciplines in the athletes data set.
4. Similarly, look at the heatmap of the pairwise correlations of the athletes.
